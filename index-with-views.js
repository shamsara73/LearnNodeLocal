...
sequelize.query("SELECT table_name, table_type FROM information_schema.tables", {
  ...
  .then(async (tables) => {
      ...
      if (tableType === 'BASE TABLE') {
        ...
        columns.forEach((column) => {
          ...
          if (sequelizeType) {
            ...
            if (columnName.toLowerCase() === 'id' && tableType === 'BASE TABLE') {
    ...
    // Sync the database schema for tables
    sequelize.sync();
